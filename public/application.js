...
/***/ function(module, exports, __webpack_require__) {
	...
	var usersOnLine = __webpack_require__(9);
	...
	var cellVal = '';
	var updatedID = 0;
	var squaresInPlay = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i'];
	var numClicks = 0;
	var numGames = 0;
	var xGames = 0;
	var oGames = 0;
	...
	var weGotAWinner = function weGotAWinner(whoWon, match) {
	  numGames = numGames + 1;
	  if (whoWon === 'X') {
	    xGames = xGames + 1;
	  } else if (whoWon === 'O') {
	...
	var playAgain = function playAgain() {
	  ...
	  for (var i = 0; i < squaresInPlay.length; i++) {
	...
	var fillSqInPlay = function fillSqInPlay() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignIn = function onSignIn(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  gameApi.signIn(data).then(gameUi.signInSuccess) // console.log(data, data.credentials.email))
	...
	var onChgPswd = function onChgPswd(event) {
	  ...
	  gameApi.chgPswd(data).then(gameUi.chgPswdSuccess).catch(gameUi.chgPswdFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var chgPswdSuccess = function chgPswdSuccess(data) {
	  //  console.log(data)
	};

	var chgPswdFailure = function chgPswdFailure(error) {
	  //  console.error(error)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setAPIOrigin = __webpack_require__(3);
	var config = __webpack_require__(6);
	var gameSApi = __webpack_require__(12);
	var gameSUi = __webpack_require__(13);

	// console.log('games js up and running')

	var getUserStats = function getUserStats() {
	  gameSApi.read().then(gameSUi.readGameSuccess).catch(gameSUi.readGameFailure);
	};

	var gameCreate = function gameCreate() {
	  gameSApi.create().then(gameSUi.newGameSuccess).catch(gameSUi.newGameFailure);
	};

	var gameUpdate = function gameUpdate(updatedGame, updatedID) {
	  gameSApi.update(updatedGame, updatedID).then(gameSUi.updateGameSuccess).catch(gameSUi.updateGameFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var update = function update(updatedGame, updatedID) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var readGameSuccess = function readGameSuccess(stats) {
	...
	var readGameFailure = function readGameFailure(game) {
	  //  console.log('read bombed')
	};

	var newGameSuccess = function newGameSuccess(game) {
	...
	var newGameFailure = function newGameFailure(game) {
	...
	var updateGameFailure = function updateGameFailure(game) {
	...
	module.exports = {
	  ...
	  readGameSuccess: readGameSuccess,
	  readGameFailure: readGameFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
